	...
	public function verSolicitudes(Request $request) {
		return view('verSolicitudes', [
            ...
            'columnas' => [
                ...
                (object)['data_column' => 1, 'nombre' => 'Editar'],
                (object)['data_column' => 2, 'nombre' => 'Folio'],
                (object)['data_column' => 3, 'nombre' => 'Etiqueta'],
                (object)['data_column' => 4, 'nombre' => 'Boleta'],
                (object)['data_column' => 5, 'nombre' => 'Curp'],
                (object)['data_column' => 6, 'nombre' => 'Género'],
                (object)['data_column' => 7, 'nombre' => 'Nombre'],
                (object)['data_column' => 8, 'nombre' => 'Carrera'],
                (object)['data_column' => 9, 'nombre' => 'Semestre'],
                (object)['data_column' => 10, 'nombre' => 'Promedio'],
                (object)['data_column' => 11, 'nombre' => 'Estatus Académico'],
                (object)['data_column' => 12, 'nombre' => 'Carga'],
                (object)['data_column' => 13, 'nombre' => 'Tipo Becario'],
                (object)['data_column' => 14, 'nombre' => 'Beca Anterior'],
                (object)['data_column' => 15, 'nombre' => 'Beca Solicitada'],
                (object)['data_column' => 16, 'nombre' => 'Folio Manutención'],
                (object)['data_column' => 17, 'nombre' => 'Folio Transporte'],
                (object)['data_column' => 18, 'nombre' => 'Mapa'],
                (object)['data_column' => 19, 'nombre' => 'Fecha Recibido'],
                (object)['data_column' => 20, 'nombre' => 'Comprobante Oficial'],
                (object)['data_column' => 21, 'nombre' => 'Ingresos'],
                (object)['data_column' => 22, 'nombre' => 'Dependientes'],
                (object)['data_column' => 23, 'nombre' => 'Ingreso Mínimo'],
                (object)['data_column' => 24, 'nombre' => 'Ingresos/Dependientes'],
                (object)['data_column' => 25, 'nombre' => 'Oriundo'],
                (object)['data_column' => 26, 'nombre' => 'Email'],
                (object)['data_column' => 27, 'nombre' => 'Teléfono'],
                (object)['data_column' => 28, 'nombre' => 'Observaciones'],
            ]
        ]);
	}
